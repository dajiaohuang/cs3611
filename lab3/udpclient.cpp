...
{
    std::map<std::string, std::string> host{{"h1", "10.0.0.1"}, {"h2", "10.0.0.2"},{"h3", "10.0.0.3"},{"h4", "10.0.0.4"},{"10.0.0.5", "h5"}};
    std::map<std::string, std::string> IP{{"10.0.0.1", "h1"}, {"10.0.0.2", "h2"},{"10.0.0.3", "h3"},{"10.0.0.4", "h4"},{"10.0.0.5", "h5"}};
